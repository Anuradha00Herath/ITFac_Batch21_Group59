...
public class TestContext {
    ...
    public String capturedPlantId;
    public String nonExistingPlantId;
    public String nonExistingCategoryId;
    public String validCategoryId;

    public String createdPlantName;
    public String createdPlantId;
    public String existingPlantId;
    public String invalidCategoryId;
