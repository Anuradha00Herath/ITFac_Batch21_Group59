...
public class SalesApiSteps {
    ...
    @Given("a sale exists \\(capture a sale id\\) as admin")
    public void a_sale_exists_capture_as_admin_alias() {
        ctx.capturedSaleId = getAnySaleIdOrThrow("admin");
        assertNotNull(ctx.capturedSaleId);
    }

    @Given("a sale exists \\(capture a sale id\\) as user")
    public void a_sale_exists_capture_as_user_alias() {
        ctx.capturedSaleId = getAnySaleIdOrThrow("user");
        assertNotNull(ctx.capturedSaleId);
    }
